  ...
  hotclen: {
    ...
    sections: [
      ...
      { title: "3. Purpose & Scope", content: [
        ...
        "• Customer outreach and lead generation agents",
      ...
      { title: "4. Selected Service Scope", items: [
        ...
        { label: "Campaign Optimization", value: "Performance monitoring and continuous agent tuning" }
      ]},
      { title: "5. Investment", content: [
  ...
  "lazy-genius": {
    ...
    sections: [
      ...
      { title: "3. Purpose & Scope", content: [
        ...
        "• Platform integration for workflow optimization",
      ...
      { title: "4. Selected Service Scope", items: [
        ...
        { label: "Agent Optimization", value: "Continuous proposal refinement and workflow iteration" }
      ]},
      { title: "5. Investment", content: [
        "• <strong>Monthly Fee:</strong> $100/month",
        "• All pricing in USD, billed monthly via Stripe",
